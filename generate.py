...
from gdpo.dataset.other import PromptOnlyAnthropicHH, PromptOnlyTLDR
from gdpo.mixin.instantiate import TorchDtypeMixin
...
class Generator(TorchDtypeMixin):
    ...
    def __init__(self, config: CommonConfig):
        ...
        if config.task == "hh":
            ...
            temp_path = Path(self.config.model.checkpoint) / "temp" / "dataset.parquet"
