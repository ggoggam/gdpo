...
default_config = {
    "sft": ("Supervised Fine-tuning", TrainConfig(algorithm=SFTConfig())),
    "dpo": ("Direct Preference Optimization", TrainConfig(algorithm=DPOConfig())),
    "gdpo": ("GFlowNet Direct Preference Optimization", TrainConfig(algorithm=GDPOConfig())),
}
