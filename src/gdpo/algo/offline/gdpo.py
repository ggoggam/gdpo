...
class GDPOTrainer(OfflineTrainer, InstantiateModelMixinWithReferenceModel):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.alpha = self.config.algorithm.alpha
        self.beta = self.config.algorithm.beta
        self.gamma = self.config.algorithm.gamma
        self.temperature = self.config.algorithm.temperature
