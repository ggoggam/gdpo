...
class GatherMetricsMixin:
    ...
    def gather(
        *args: torch.Tensor,
        ...
        Returns:
            tuple[torch.Tensor, ...] | torch.Tensor: Gathered metrics moved to cpu
        """
...
class ComputeMixin:
    ...
    def compute_token_logps(
        ...
        Args:
            ...
            slide_mask (bool, optional): slides mask to the left if true. Defaults to False.
            temperature (float, optional): probability temperature. Defaults to 1.0.

        Returns:
            tuple[torch.FloatTensor, torch.BoolTensor]: masked log probability and mask.
        """
        assert (
